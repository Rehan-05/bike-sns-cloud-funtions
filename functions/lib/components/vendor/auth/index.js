...
router.post('/register', (0, express_validator_1.checkSchema)(auth_validation_1.REGISTER_VENDOR_SCHEMA), validation_1.checkValidation, controller.createVendor);
...
router.put('/logout', auth_1.isVendor, controller.logout);
