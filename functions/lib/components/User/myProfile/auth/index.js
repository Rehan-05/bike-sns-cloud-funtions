...
router.post('/register', (0, express_validator_1.checkSchema)(auth_validation_1.REGISTERATION_SCHEMA), validation_1.checkValidation, controller.registrationUser);
