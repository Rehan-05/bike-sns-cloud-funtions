...
const verifyEmailAddress = async (email) => {
    ...
    try {
        ...
        let tokenId = await config_1.db.collection('EmailVerification_token').add({ email: email, token: token, expiry: expiry });
